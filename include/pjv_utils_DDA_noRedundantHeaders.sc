...
uint findVoxelIndex(BoxAABB voxelBoundingBox, uint headerIndex, out uint voxelTypeDataStartIndex){
    ...
    voxelTypeDataStartIndex = h.voxelTypeDataStartIndex;
...
Voxel fetchVoxelData(BoxAABB voxelBoundingBox, uint headerIndex){
    uint voxelTypeDataStartIndex;
    uint voxelIndex = findVoxelIndex(voxelBoundingBox, headerIndex, voxelTypeDataStartIndex);
