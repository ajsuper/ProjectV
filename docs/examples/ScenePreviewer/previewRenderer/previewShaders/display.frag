...
// =============================================================================
// display.frag  --  Pass 3 of the scene previewer.
//
// Copies the accumulated image to the back buffer, deliberately doing nothing to
// it. The lit renderers ACES tone-map and gamma-encode here because they produce
