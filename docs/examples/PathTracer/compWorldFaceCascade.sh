#!/bin/bash
# Compiles the worldFaceCascadeRenderer shaders (vertex + fragment) to bgfx .bin.
echo "Compiling worldFaceCascadeRenderer shaders..."
PROJECTV_DIR=../../../
...
SHADER_DIR=./worldFaceCascadeRenderer/pathTracerShaders
