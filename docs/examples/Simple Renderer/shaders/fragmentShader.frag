...
vec4 castRay(){
    Ray ray;
    ray.direction = rayStartDirection(TexCoords, resolution, cameraPos, normalize(vec3(cameraDir.x, 0, cameraDir.z)), 90);
    ...
    vec3 sunDirection = normalize(vec3(0.7, 0.99, -0.4));
